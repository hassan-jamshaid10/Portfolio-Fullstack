...
const experiences = [
  {
    ...
    logo: "./netsollogo.png",
    description: "Worked as a Full Stack Developer intern, building web applications using React for frontend development and Spring Boot for backend services. Gained hands-on experience with RESTful APIs, database design, and learned about industry best practices in a professional development environment.",
  ...
  },
  {
    ...
    logo: "/payologo.png",
    description: "Led the development of the organization's official website, focusing on creating a modern and user-friendly interface. Managed the organization's digital presence including website maintenance and social media strategy to improve member engagement and outreach.",
  ...
  },
  {
    ...
    logo: "/Logo2.png",
    description: "Developed and maintained the IEEE Computer Society UCP Student Chapter's website, focusing on creating an intuitive user experience. Worked with the executive team to add event information, resources, and content to improve the chapter's online presence and member engagement.",
  ...
  },
  {
    ...
    description: "Working as a freelance developer, providing web development services to clients through Fiverr, Upwork, and local projects. Focus on building responsive web applications and implementing custom features to meet client requirements, while continuously learning new technologies and improving my skills.",
