...
const NetsolLogo="https://logosandtypes.com/wp-content/uploads/2020/10/NetSol.png";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start">
              ...
              <img src={NetsolLogo} alt="Netsol" width={85} height={85} className="mx-auto" />
              </div>
              <div className="ml-6">
            ...
            <div className="flex items-start">
              ...
              <img src={Freelancelogo} alt="Freelance" width={85} height={115} className="mx-auto" />
              </div>
              <div className="ml-6">
        ...
        <div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start">
              <div className="w-10 h-10 rounded-full bg-[#229799] flex-shrink-0 flex items-center justify-center text-white">
              <img src={ucpLogo} alt="UCP" width={85} height={85} className="mx-auto" />
              </div>
              <div className="ml-6">
